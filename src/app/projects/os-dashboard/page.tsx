...
export default function OSDashboardPage() {
  ...
  const t = translations[language].osDashboard;

  const images = [
    { src: "/os-dashboard/global.jpeg", alt: "Global System View" },
    { src: "/os-dashboard/memory.jpeg", alt: "Memory Monitoring" },
    { src: "/os-dashboard/process.jpeg", alt: "Process Management" },
    { src: "/os-dashboard/dirs.jpeg", alt: "Directory Navigation" },
    { src: "/os-dashboard/archives_sys.jpeg", alt: "File System Archives" }
  ];
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className={`p-6 rounded-xl ${isDarkMode ? 'bg-white/5' : 'bg-white/70'}`}>
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>main.py: inicialização da aplicação</li>
            <li>controller/: lógica de controle e atualizações de dados</li>
            <li>model/: coleta de informações do sistema, processos e arquivos</li>
            <li>view/: interface gráfica (Tkinter + Matplotlib)</li>
          </ul>
        </section>

        <section className={`p-6 rounded-xl ${isDarkMode ? 'bg-white/5' : 'bg-white/70'}`}>
          <h2 className="text-2xl font-semibold mb-4">{t.techStack}</h2>
          <ul className="space-y-3 list-disc list-inside">
            {t.tech.map((tech, i) => (
              <li key={i}>{tech}</li>
            ))}
        ...
        <Link
          href="https://github.com/MateusSilva00/operating_system_dashboard"
          target="_blank"
